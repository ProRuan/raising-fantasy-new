class LevelWorld extends World {
    ...
    // IV. Replace timeout with (pauseable timeout or nextTime)? ... (timeout (7/8) + pauseTimeout(7/8))
    // Fix LevelWorld timeout/next/last + pauseOffset ...
    // Fix pause for touch ... !!!

    // V. Pause sounds (array) ...
    // VI. Pause Objects by own interval + calculate pause time in class PauseableInterval ...
}